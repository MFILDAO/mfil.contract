...
abstract contract MFil is IERC20, Pausable {
    ...
    bytes32 internal constant TOTAL_SHARES_POSITION = keccak256("mfil.MFil.totalShares");
    ...
    function _getTotalShares() internal view returns (uint256) {
        return TOTAL_SHARES_POSITION.getUint256Slot().value;
    }
    ...
    function _mintShares(address _recipient, uint256 _sharesAmount) internal whenNotStopped returns (uint256 newTotalShares) {
        ...
        TOTAL_SHARES_POSITION.getUint256Slot().value = newTotalShares;
